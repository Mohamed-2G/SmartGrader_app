...
def format_grading_prompt(
    ...
    prompt_parts = [
        ...
        "Please evaluate the student's answer based on the provided rubric and provide detailed feedback in the same language as the student's answer and question",
        "",
        "QUESTION:",
        question,
        "",
    ...
    prompt_parts.append("")
    prompt_parts.append("Please provide your evaluation in the same language as the student's answer and question and in the following format:")
